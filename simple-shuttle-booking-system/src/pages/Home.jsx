...
const Home = () => {
  ...
  return (
    <div className="h-screen w-screen flex flex-col justify-center items-center bg-gradient-to-br from-blue-100 to-blue-200 text-center px-4">
      <h1 className="text-4xl md:text-6xl font-bold text-blue-900 mb-6 tracking-wide drop-shadow-md">
        Welcome to Shuttle Booking System
      </h1>
      <p className="text-lg md:text-2xl text-blue-700 font-medium mb-8 max-w-4xl">
        Book your shuttle easily and manage your trips with convenience.
      </p>

      <div className="w-full h-2/5 md:h-3/5 relative overflow-hidden rounded-2xl shadow-lg flex items-center justify-center bg-white">
        <img
          src={images[current]}
      ...
      <a
        href="/signup"
        className="inline-block mt-auto mb-8 text-blue-900 font-bold underline text-lg md:text-xl tracking-wide bg-blue-50 px-8 py-3 rounded-lg shadow-md hover:bg-blue-100 transition-colors duration-200"
      >
